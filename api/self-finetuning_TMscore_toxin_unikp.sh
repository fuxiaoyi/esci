...
# run command #
###############
folder_path="/home/bingxing2/ailab/scxlab0094/hantao/project/internTA/proteinGflownet/ProtRL/experiments/Self-finetuning/s-FT_TM-score_tmUni1_v2/"
label="1.1.1.27"
smiles="CC(=O)C(=O)O"
