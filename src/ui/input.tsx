...
const Input = (props: Props) => {
  return (
    <div className={ props.inline ? "flex" : "" }>
      ...
      <div className={ "relative flex flex-col gap-1 rounded-md shadow-sm " + (props.inline ? "flex-1" : "") }>
        {props.helpText && (
          <p
