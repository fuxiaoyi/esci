      ...
      {({ open }) => (
        <>
          <div className="relative">
            <Listbox.Button
              className={clsx(
                "border-1 relative h-6 w-full cursor-default rounded-md border border-black bg-white px-1 text-left text-xs text-black focus:outline-none focus:ring-1 focus:ring-cyan-500",
