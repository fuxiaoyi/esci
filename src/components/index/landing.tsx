...
const Landing = (props: LandingProps) => {
  ...
  return (
    ...
    <>
      <div style={{ 
        backgroundImage: `url(${'/logos/kongfoo-fp.png'})`,
      ...
      >
        ...
        <div className="flex w-full flex-row items-center justify-center gap-3">
          <Button
            ...
            className="h-full bg-gradient-to-t from-amber-800 to-amber-600 hover:shadow-depth-3"
          >
            <FaCog />
          </Button>
          <Button
            onClick={props.handlePlay}
            className="border-0 bg-gradient-to-t from-emerald-600 to-cyan-600 subpixel-antialiased saturate-[75%] hover:saturate-100"
          >
            <FaPlay />
          </Button>
        </div>
