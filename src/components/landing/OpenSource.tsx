      ...
      <div className="flex flex-row">
          ...
          <Terminal className="absolute" title="index.ts">
            <pre className="overflow-x-hidden">
              {"" +
                ...
                "<html>\n" +
                "<head>\n" +
                " <title>My E.Copi Website</title>\n" +
                "</head>\n" +
                "<body>\n" +
                "  <h1>Welcome to E.Copi!</h1>\n" +
                "  <p>Explore the power of autonomous AI agents.</p>\n" +
                '  <script src="https://agentds.kongfoo.ai/agentds.js"></script>\n' +
                "  <script>\n" +
                "    // Connect to AgentDS API\n" +
                "    const agent = new AgentDS();\n" +
                "    agent.connect('YOUR_API_KEY');\n" +
                "    \n" +
                "    // Example code to interact with AgentDS\n" +
          ...
          <Terminal className="absolute left-16 top-20 z-10" title="agent_service.py">
            <pre className="overflow-x-hidden">
              {"import requests\n" +
                ...
                'url = "https://api.agentds.example.com"\n' +
                "\n" +
        ...
        <div className="mt-28 w-full">
          ...
          <div className="mt-6 flex flex-row gap-4">
            <a href="https://github.com/kongfoo" target="_blank">
              <PrimaryButton>View on Github</PrimaryButton>
            </a>
            <a href="https://github.com/orgs/kongfoo/projects/3" target="_blank">
