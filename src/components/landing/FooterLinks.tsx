...
const FooterLinks = () => {
  return (
    <div className="hidden cursor-pointer flex-row justify-center space-x-4 lg:flex">
      <FooterLink href="https://www.ycombinator.com/companies/kongfoo/jobs">Careers</FooterLink>
      <FooterLink href="https://status.kongfoo.ai">
      ...
      <FooterLink href="https://agentds.kongfoo.ai/privacypolicy">Privacy</FooterLink>
      <FooterLink href="https://agentds.kongfoo.ai/terms">Terms</FooterLink>
    </div>
  );
};
