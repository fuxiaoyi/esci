...
export const ChatWindowTitle = ({ model }: { model: GPTModelNames }) => {
  if (model === GPT_4) {
    return (
      <>
        Agent<span className="text-amber-500">KFM-alpha</span>
      </>
    );
  }
    ...
    return (
      <>
        ...
        <span className="text-neutral-400">
          KFM-alpha<span className="text-amber-500">-16K</span>
        </span>
      </>
    );
  }
  ...
  return (
    <>
      Agent<span className="text-neutral-400">KFM-alpha</span>
    </>
  );
};
