...
import { COZE_API_CONFIG } from '@/lib/coze-api';
...
const DialogueSection = () => {
  // Create a ref for clear messages functionality
  const clearMessagesRef = React.useRef(false);
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-6 md:mb-0">
            <div className="flex items-center space-x-2">
              <img src={logo} alt="Edge Science Logo" className="w-8 h-8" />
          ...
          <div className="flex flex-wrap justify-center gap-8">
            ...
            <a href="#" className="text-neutral-600 hover:text-darkGreen-600 transition-colors">Documentation</a>
            <a href="#" className="text-neutral-600 hover:text-darkGreen-600 transition-colors">Contact</a>
          </div>
        </div>
